...
(function() {
	...
	var d = BMapLib.DistanceTool = function(f, e) {
		...
		this._opts = c.extend(c.extend(this._opts || {}, {
			...
			opacity: 0.8,
			lineStyle: "solid",
			cursor: "https://api.map.baidu.com/images/ruler.cur",
			secIcon: null,
			closeIcon: null
		}), e);
		...
		this._styles = {
			BMapLib_diso: "height:17px;width:5px;position:absolute;background:url(https://api.map.baidu.com/images/dis_box_01.gif) no-repeat left top",
			BMapLib_disi: "color:#7a7a7a;position:absolute;left:5px;padding:0 4px 1px 0;line-height:17px;background:url(https://api.map.baidu.com/images/dis_box_01.gif) no-repeat right top",
	...
	d.prototype._addSecPoint = function(g) {
		var f = this._opts.secIcon ? this._opts.secIcon : new BMap.Icon("https://api.map.baidu.com/images/mapctrls.png", new BMap.Size(11, 11), {
	...
	d.prototype._processLastOp = function() {
		...
		var m = this._opts.closeIcon ? this._opts.closeIcon : new BMap.Icon("https://api.map.baidu.com/images/mapctrls.gif", new BMap.Size(12, 12), {
	...
	var a = {
		_map: null,
		_html: "<div style='background:transparent url(https://api.map.baidu.com/images/blank.gif);position:absolute;left:0;top:0;width:100%;height:100%;z-index:1000' unselectable='on'></div>",
		_maskElement: null,
		_cursor: "default",
		_inUse: false,
		show: function(e) {

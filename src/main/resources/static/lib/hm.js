(function() {
	var h = {},
		mt = {},
		c = {
			id: "1f8e83330039496a701d7ae44836ed10",
			dm: ["yuqiao.cn"],
	...
	mt.h.cb = function(a) {
		return(a = mt.h.L(a, s)) && a.length ? String(a[0]) : ""
	};
	mt.h.bb = function(a) {
		return mt.h.L(a, u)
	};
	...
	(function() {
		...
		function b() {
			...
			if((!l || !e) && p && k) x = s, m = +new Date;
			else if(l && e && (!p || !k)) x = u, q += +new Date - m;
			l = p;
			e = k;
			y = setTimeout(b, 100)
		}
	...
	(function() {
		function a(a, d, m, b) {
			if(!(a === r || d === r || b === r)) {
				...
				a = String(a).split("!");
				for(var e, v = u, f = 0; f < a.length; f++)
			...
			e = {
				...
				init: function() {
					...
					l.c("stag-b", function() {
						...
						h.b.a.ct = [decodeURIComponent(h.b.getData("Hm_ct_" + c.id) || ""), e.o.U, e.o.page].join("!")
					});
					l.c("stag-d", function() {
						h.b.a.api = 0;
						e.e = 0;
				...
				pa: function() {
					if(0 < e.z.length)
						for(var a = 0, d = e.z.length; a < d; a++) e.R(e.z[a]);
					e.z = t
				},
				R: function(a) {
					var b = a[0];
				...
				_trackPageview: function(a) {
					if(1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
						...
						h.b.a.vl = g.M() + g.N();
						h.b.a.kb = 0;
						h.b.O ? (h.b.a.nv = 0, h.b.a.st = 4) : h.b.O = s;
						var d = h.b.a.u,
							b = h.b.a.su;
	...
	(function() {
		function a() {
			"undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = s, this.a = {}, this.Z = s, this.O = u, this.init())
		}
		var b = mt.url,
			d = mt.da,
			f = mt.T,
		...
		a.prototype = {
			...
			va: function() {
				...
				var a = u;
				this.C(document.referrer) && this.C(document.location.href) ? a = s : (a = b.Y(document.referrer), a = this.P(a || "", document.location.hostname));
			...
			init: function() {
				try {
					this.Oa(), 0 === this.a.nv ? this.La() : this.S(".*"), h.b = this, this.ka(), w.B("pv-b"), this.Ka()
				} catch(a) {
					var b = [];
					b.push("si=" + c.id);
			...
			Ka: function() {
				...
				this.Z ? (this.O = s, this.a.et = 0, this.a.ep = "", this.a.vl = l.M() + l.N(), this.j(a)) : a()
			},
			j: function(a) {
				var b = this;

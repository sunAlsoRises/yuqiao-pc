...
! function(e) {
    ...
    function r(e) {
        ...
        if(d(e.body)) {
            ...
            if(e.deps)
                for(var a = 0, s = e.deps.length; a < s; a++) {
                    var l;
    ...
    if(void 0 === define) {
        ...
        define = function() {
            ...
            if(3 == r.length) e = r[0], t = r[1], n = r[2];
            else if(2 == r.length) e = r[0], n = r[1];
            else {
    ...
    function(e, t) {
        ...
        function c(e, t, n, r) {
            if(re.acceptData(e)) {
                var i, o, a = re.expando,
                    ...
                    l = s ? re.cache : e,
                    u = s ? e[a] : e[a] && a;
                if(u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[a] = U.pop() || re.guid++ : a), l[u] || (l[u] = s ? {} : {
                    toJSON: re.noop
        ...
        function M(e, t, n) {
            ...
            if(re.isEmptyObject(f)) "inline" === ("none" === u ? C(e.nodeName) : u) && (d.display = u);
            else {
        ...
        var le = function(e) {
            ...
            function m(e, t, n, i, o, a) {
                return i && !i[O] && (i = m(i)), o && !o[O] && (o = m(o, a)), r(function(r, a, s, l) {
                    var u, c, f, d = [],
                        ...
                        b = n ? o || (r ? e : g || i) ? [] : a : y;
                    if(n && n(y, b, s, l), i)
                        for(u = h(b, m), i(u, [], s, l), c = u.length; c--;)(f = u[c]) && (b[m[c]] = !(y[m[c]] = f));
                    if(r) {
                        if(o || e) {
                            if(o) {
            ...
            var y, b, x, w, T, E, S, C, N, k, _, j, A, L, D, q, H, $, M, O = "sizzle" + -new Date,
                R = e.document,
                F = 0,
                B = 0,
                P = n(),
                        ...
                        return 1 === r && 0 === i ? function(e) {
                            ...
                            if(g) {
                                ...
                                if(h = [a ? g.firstChild : g.lastChild], a && y) {
                                    for(c = g[O] || (g[O] = {}), u = c[e] || [], p = u[0] === F && u[1], d = u[0] === F && u[2], f = p && g.childNodes[p]; f = ++p && f && f[m] || (d = p = 0) || h.pop();)
                                        if(1 === f.nodeType && ++d && f === t) {
                                            c[e] = [F, p, d];
                                            break
                                        }
                                } else if(y && (u = (t[O] || (t[O] = {}))[e]) && u[0] === F) d = u[1];
                                else
                                    for(;
                                        (f = ++p && f && f[m] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[O] || (f[O] = {}))[e] = [F, d]), f !== t)););
        ...
        var He = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
            ...
            Ue = m(pe),
            Ye = Ue.appendChild(pe.createElement("div"));
        Ve.optgroup = Ve.option, Ve.tbody = Ve.tfoot = Ve.colgroup = Ve.caption = Ve.thead, Ve.th = Ve.td, re.extend({
            clone: function(e, t, n) {
                ...
                if(ne.html5Clone || re.isXMLDoc(e) || !Me.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ye.innerHTML = e.outerHTML, Ye.removeChild(o = Ye.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || re.isXMLDoc(e)))
            ...
            buildFragment: function(e, t, n, r) {
                    ...
                    if((o = e[h]) || 0 === o)
                        if("object" === re.type(o)) re.merge(p, o.nodeType ? [o] : o);
                            ...
                            if(!ne.leadingWhitespace && Oe.test(o) && p.push(t.createTextNode(Oe.exec(o)[0])), !ne.tbody)
                                for(o = "table" !== l || Be.test(o) ? "<table>" !== c[1] || Be.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) re.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
                ...
                for(s && d.removeChild(s), ne.appendChecked || re.grep(g(p, "input"), v), h = 0; o = p[h++];)
                    if((!r || -1 === re.inArray(o, r)) && (a = re.contains(o.ownerDocument, o), s = g(d.appendChild(o), "script"), a && w(s), n))
                        for(i = 0; o = s[i++];) We.test(o.type || "") && n.push(o);
                return s = null, d
            },
            ...
            domManip: function(e, t) {
                ...
                if(u && (s = re.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                    ...
                    if(i)
                        for(a = o[o.length - 1].ownerDocument, re.map(o, x), l = 0; l < i; l++) r = o[l], We.test(r.type || "") && !re._data(r, "globalEval") && re.contains(a, r) && (r.src ? re._evalUrl && re._evalUrl(r.src) : re.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Xe, "")));
                    s = n = null
                }
                return this
            }
        ...
        re.fn.extend({
            ...
            removeAttr: function(e, t) {
                var n, r, i = 0,
                    o = t && t.match(ve);
                if(o && 1 === e.nodeType)
                    for(; n = o[i++];) r = re.propFix[n] || n, re.expr.match.bool.test(n) ? St && Et || !Tt.test(n) ? e[r] = !1 : e[re.camelCase("default-" + n)] = e[r] = !1 : re.attr(e, n, ""), e.removeAttribute(Et ? n : r)
            },
            attrHooks: {
                type: {
                    set: function(e, t) {
                    ...
                    send: function(n, r) {
                        ...
                        o.send(e.hasContent && e.data || null), t = function(n, i) {
                            ...
                            if(t && (i || 4 === o.readyState))
                                if(delete Gt[a], t = void 0, o.onreadystatechange = re.noop, i) 4 !== o.readyState && o.abort();
                                else {
    ...
    return "function" != typeof Object.create && (Object.create = function() {
        ...
        for(var a in t) {
            ...
            else if("object" == typeof s && i[a] && "object" == typeof i[a])
                for(var l in i[a]) s[l] || (s[l] = i[a][l]);
            o[a] = s
        }
        ...
        off: function(e, t) {
            ...
            if(r && r.length) {
                ...
                for(var i = 0, o = r.length; i < o; i++)
                    if(r[i] == t || r[i] == t.fn) return void r.splice(i, 1)
            }
        },
        trigger: function(e) {
            if(e) {
    ...
    var rsplit = function(e, t) {
        ...
        EJS = function(e) {
            if(e = "string" == typeof e ? {
                view: e
            } : e, this.set_options(e), e.precompiled) return this.template = {}, this.template.process = e.precompiled, void EJS.update(this.name, this);
            if(e.element) {
    ...
    return EJS.prototype = {
        ...
        update: function(element, options) {
            if("string" == typeof element && (element = document.getElementById(element)), null == options) return _template = this,
                function(e) {
    ...
    return e.extend({
        ...
        _triggerSuccess_: function(e) {
            var t = this;
            e = t.parse ? t.parse(e) : e, t.data = e, t.trigger("request", e)
        },
        setData: function(e) {
    ...
    if("string" == typeof e) e = e.replace(/-/g, "/"), e.indexOf("/") >= 0 ? e = new Date(e) : isNaN(parseInt(e)) || (e = new Date(parseInt(e)));

! function(e, t) {
	...
	function _(e, t, n) {
		var r, i, o = 0,
			...
			l = c.props;
		for(I(l, c.opts.specialEasing); o < a; o++)
	...
	le.fn = le.prototype = {
			...
			init: function(e, n, r) {
				...
				if("string" == typeof e) {
					...
					if(i[1]) {
						if(n = n instanceof le ? n[0] : n, le.merge(this, le.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : Y, !0)), ve.test(i[1]) && le.isPlainObject(n))
			...
			if(!V)
				if(V = le.Deferred(), "complete" === Y.readyState) setTimeout(le.ready);
				else if(Y.addEventListener) Y.addEventListener("DOMContentLoaded", Ce, !1), e.addEventListener("load", Ce, !1);
			else {
		...
		function(e, t) {
			...
			function m(e, t, n, r, o, a) {
				return r && !r[q] && (r = m(r)), o && !o[q] && (o = m(o, a)), i(function(i, a, s, u) {
					var c, l, f, p = [],
						d = [],
						h = a.length,
						v = i || b(t || "*", s.nodeType ? [s] : s, []),
						m = !e || !i && t ? v : g(v, p, e, s, u),
						y = n ? o || (i ? e : h || r) ? [] : a : m;
					if(n && n(m, y, s, u), r)
						for(c = g(y, d), r(c, [], s, u), l = c.length; l--;)(f = c[l]) && (y[d[l]] = !(m[d[l]] = f));
					if(i) {
						if(o || e) {
							if(o) {
			...
			function y(e) {
				for(var t, n, r, i = e.length, o = k.relative[e[0].type], a = o || k.relative[" "], s = o ? 1 : 0, u = h(function(e) {
					...
					if(n = k.relative[e[s].type]) l = [h(v(l), n)];
					else {
						if(n = k.filter[e[s].type].apply(null, e[s].matches), n[q]) {
							for(r = ++s; r < i && !k.relative[e[r].type]; r++);
							return m(s > 1 && v(l), s > 1 && d(e.slice(0, s - 1).concat({
								value: " " === e[s - 2].type ? "*" : ""
							})).replace(ce, "$1"), n, s < r && y(e.slice(s, r)), r < i && y(e = e.slice(r)), r < i && d(e))
						}
						l.push(n)
					}
				return v(l)
				...
				var r = 0,
					...
					s = function(i, s, u, c, l) {
						var f, p, d, h = [],
							...
							$ = null != l,
							b = N,
							x = i || a && k.find.TAG("*", l && s.parentNode || s),
			...
			function x(e, t, n, r) {
				...
				if(!r && 1 === c.length) {
					...
					for(i = me.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !k.relative[s = a.type]);)
						if((u = k.find[s]) && (r = u(a.matches[0].replace(Ce, Se), de.test(o[0].type) && t.parentNode || t))) {
			...
			var w, C, S, k, T, E, A, N, j, D, O, M, L, P, H, F, R, q = "sizzle" + -new Date,
				_ = e.document,
				I = 0,
				B = 0,
				z = r(),
			...
			E = n.isXML = function(e) {
				...
				var r = k.attrHandle[n.toLowerCase()],
					i = r && Y.call(k.attrHandle, n.toLowerCase()) ? r(e, n, !L) : t;
						...
						return 1 === r && 0 === i ? function(e) {
							...
							if(g) {
								...
								if(h = [a ? g.firstChild : g.lastChild], a && y) {
									for(l = g[q] || (g[q] = {}), c = l[e] || [], d = c[0] === I && c[1], p = c[0] === I && c[2], f = d && g.childNodes[d]; f = ++d && f && f[v] || (p = d = 0) || h.pop();)
										if(1 === f.nodeType && ++p && f === t) {
											l[e] = [I, d, p];
											break
										}
								} else if(y && (c = (t[q] || (t[q] = {}))[e]) && c[0] === I) p = c[1];
								else
									for(;
										(f = ++d && f && f[v] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++p || (y && ((f[q] || (f[q] = {}))[e] = [I, p]), f !== t)););
				...
				pseudos: {
					...
					lang: i(function(e) {
						return ge.test(e || "") || n.error("unsupported lang: " + e), e = e.replace(Ce, Se).toLowerCase(),
							function(t) {
								var n;
								do
	...
	le.fn.extend({
		...
		removeAttr: function(e, t) {
			var n, r, i = 0,
				o = t && t.match(pe);
			if(o && 1 === e.nodeType)
				for(; n = o[i++];) r = le.propFix[n] || n, le.expr.match.bool.test(n) ? He && Pe || !Le.test(n) ? e[r] = !1 : e[le.camelCase("default-" + n)] = e[r] = !1 : le.attr(e, n, ""), e.removeAttribute(Pe ? n : r)
		},
		attrHooks: {
			type: {
				set: function(e, t) {
		...
		remove: function(e, t, n, r, i) {
			...
			if(g && (l = g.events)) {
				for(t = (t || "").match(pe) || [""], c = t.length; c--;)
					if(s = Ie.exec(t[c]) || [], d = v = s[1], h = (s[2] || "").split(".").sort(), d) {
	...
	le.fn.extend({
		...
		closest: function(e, t) {
			for(var n, r = 0, i = this.length, o = [], a = Ue.test(e) || "string" != typeof e ? le(e, t || this.context) : 0; r < i; r++)
	...
	at.optgroup = at.option, at.tbody = at.tfoot = at.colgroup = at.caption = at.thead, at.th = at.td, le.fn.extend({
		...
		clone: function(e, t, n) {
			...
			if(le.support.html5Clone || le.isXMLDoc(e) || !Xe.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ut.innerHTML = e.outerHTML, ut.removeChild(o = ut.firstChild)), !(le.support.noCloneEvent && le.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || le.isXMLDoc(e)))
		...
		buildFragment: function(e, t, n, r) {
			for(var i, o, a, s, u, c, l, f = e.length, p = d(t), h = [], v = 0; v < f; v++)
				if(o = e[v], o || 0 === o)
			...
			for(s && p.removeChild(s), le.support.appendChecked || le.grep(b(h, "input"), x), v = 0; o = h[v++];)
				if((!r || le.inArray(o, r) === -1) && (a = le.contains(o.ownerDocument, o), s = b(p.appendChild(o), "script"), a && m(s), n))
					...
					u.send(n.hasContent && n.data || null), r = function(e, i) {
						...
						try {
							if(r && (i || 4 === u.readyState))
								if(r = t, a && (u.onreadystatechange = le.noop, Gt && delete Xt[a]), i) 4 !== u.readyState && u.abort();
								else {
...
jaaulde.utils = jaaulde.utils || {}, jaaulde.utils.cookies = function() {
		...
		return e = function(e) {
			...
			if("object" == typeof r && null !== r || (r = {}), "undefined" == typeof n || null === n) n = "", r.hoursToLive = -8760;
	...
	function() {
		(window.jQuery || window.Zepto) && ! function(e) {
			...
			var t = {
				cookify: function(t) {
					return this.each(function() {
						var n, r, i, o = ["name", "id"],
							a = e(this);
						for(n in o)
							if(!isNaN(n) && (r = a.attr(o[n]), "string" == typeof r && "" !== r)) {
				...
				cookieFill: function() {
					return this.each(function() {
						var t, n, r, i, o = ["name", "id"],
							a = e(this);
						for(n = function() {
								return t = o.pop(), !!t
							}; n();)
							if(r = a.attr(t), "string" == typeof r && "" !== r) {
	...
	function(e, t, n) {
		...
		function se(t) {
			...
			xn("ng", ["ngLocale"], ["$provide", function(e) {
				e.provider({
					...
					ngInclude: ui
				}).directive(Nr).directive(oi), e.provider({
					$anchorScroll: Le,
					$animate: er,
					$browser: Fe,
					$cacheFactory: Re,
		...
		function le(e, t, n, r) {
			function i(e) {
				var i, a, s, u, c, l, f, p = n && e ? [this.filter(e)] : [this],
					d = t;
				if(!r || null != e)
					for(; p.length;)
						for(i = p.shift(), a = 0, s = i.length; a < s; a++)
							for(u = $n(i[a]), d ? u.triggerHandler("$destroy") : d = !d, c = 0, l = (f = u.children()).length; c < l; c++) p.push(bn(f[c]));
		...
		function pe(e, t) {
			var n, r, i, o, a, s, u = t.createDocumentFragment(),
				c = [];
			if(fe(e)) c.push(t.createTextNode(e));
			else {
		...
		function Te(e, t, r) {
			...
			for(var i = Nn(t) ? t : [t]; e.length;) {
				for(var o = e[0], a = 0, s = i.length; a < s; a++)
			...
			function l(e) {
				...
				return o(e, function(e) {
					if(!m.get(e)) {
						...
						try {
							if(b(e))
								for(t = xn(e), a = a.concat(l(t.requires)).concat(t._runBlocks), n = t._invokeQueue, r = 0, i = n.length; r < i; r++) {
									var o = n[r],
										s = x.get(o[0]);
									s[o[1]].apply(s, o[2])
		...
		function He(e, t, r, i) {
			...
			c.cookies = function(e, t) {
				...
				if(!e) {
					if(l.cookie !== N)
						for(N = l.cookie, o = N.split("; "), A = {}, s = 0; s < o.length; s++) a = o[s], u = a.indexOf("="), u > 0 && (e = unescape(a.substring(0, u)), A[e] === n && (A[e] = unescape(a.substring(u + 1))));
					return A
				}
		...
		function _e(e, r) {
			...
			this.directive = function p(t, n) {
				...
				function A(e, t, r, i, o, a) {
					function s(e, r, i, o) {
						var a, s, u, c, l, f, p, d, v, g = r.length,
							m = new Array(g);
					...
					switch(u) {
						case 1:
							...
							if(a = e.className, b(a) && "" !== a)
								for(; o = c.exec(a);) d = Ie(o[2]), F(t, d, "C", r, i) && (n[d] = jn(o[3])), a = a.substr(o.index + o[0].length);
							break;
						case 3:
							z(t, e.nodeValue);
							break;
				...
				function M(e, i, a, s, c, l, f, p, d) {
					function h(e, t, n, r) {
						e && (n && (e = O(e, n, r)), e.require = w.require, e.directiveName = S, (I === w || w.$$isolateScope) && (e = X(e, {
							isolateScope: !0
						})), f.push(e)), t && (n && (t = O(t, n, r)), t.require = w.require, t.directiveName = S, (I === w || w.$$isolateScope) && (t = X(t, {
							isolateScope: !0
						})), p.push(t))
					}
				...
				function F(t, r, o, s, c, l, f) {
					...
					if(i.hasOwnProperty(r))
						for(var h, v = e.get(r + a), g = 0, m = v.length; g < m; g++) try {
				...
				function _(e, t, n, r, i, a, s, u) {
					...
					return t.empty(), p.get(w.getTrustedResourceUrl(y), {
							cache: h
						}).success(function(f) {
							var p, h, b, x;
							if(f = K(f), g.replace) {
			...
			this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, t, r, i, l, p) {
				...
				function g(r, o, s) {
					...
					var p, h, v = l.defer(),
						g = v.promise,
						b = x(r.url, r.params);
					if(d.pendingRequests.push(r), g.then(f, f), (r.cache || a.cache) && r.cache !== !1 && "GET" == r.method && (p = $(r.cache) ? r.cache : $(a.cache) ? a.cache : w), p)
						if(h = p.get(b), y(h)) {
						...
						try {
							for(var t, n = 0, a = g; n < a; n++) {
								if("function" == typeof(t = v[n]))
									if(t = t(e), t = c ? i.getTrusted(c, t) : i.valueOf(t), null == t) t = "";
		...
		function Et() {
			...
			this.digestTtl = function(t) {
				...
				l.prototype = {
					...
					$digest: function() {
						var r, i, o, s, u, c, l, d, h, v, m, y = this.$$asyncQueue,
							...
							e: do {
								if(s = d.$$watchers)
									for(u = s.length; u--;) try {
										if(r = s[u])
											if((i = r.get(d)) === (o = r.last) || (r.eq ? H(i, o) : "number" == typeof i && "number" == typeof o && isNaN(i) && isNaN(o))) {
												if(r === n) {
													c = !1;
													break e
												}
								...
								if(!(l = d.$$childHead || d !== x && d.$$nextSibling))
									for(; d !== x && !(l = d.$$nextSibling);) d = d.$parent
							} while (d = l);
					...
					$broadcast: function(e, t) {
						for(var n, r, i, o = this, s = o, u = o, c = {
							...
							for(c.currentScope = s, n = s.$$listeners[e] || [], r = 0, i = n.length; r < i; r++)
								if(n[r]) try {
									n[r].apply(null, l)
								} catch(f) {
									a(f)
								} else n.splice(r, 1), r--, i--;
							if(!(u = s.$$listenerCount[e] && s.$$childHead || s !== o && s.$$nextSibling))
								for(; s !== o && !(u = s.$$nextSibling);) s = s.$parent
						}
						return c
					}
				};
			...
			return function(e, t, n) {
				...
				i.check = function(e) {
					...
					if(e && t && "object" == typeof e && "object" == typeof t) {
						for(var r in e)
							if("$" !== r.charAt(0) && hn.call(e, r) && n(e[r], t[r])) return !0;
						return !1
					}
		...
		function zt(e, t, n, r, i) {
			...
			if(c) i > 0 && e > -1 && e < 1 && (s = e.toFixed(i));
			else {
				...
				var h, v = 0,
					...
					y = t.gSize;
				if(d.length >= g + y)
					for(v = d.length - g, h = 0; h < v; h++)(v - h) % y === 0 && 0 !== h && (s += n), s += d.charAt(h);
		...
		function en(e, t, n, r) {
			...
			a.$name = t.name || t.ngForm, a.$dirty = !1, a.$pristine = !0, a.$valid = !0, a.$invalid = !1, s.$addControl(a), e.addClass(Br), i(!0), a.$addControl = function(e) {
				...
				var r = c[e];
				if(t) r && (M(r, n), r.length || (u--, u || (i(t), a.$valid = !0, a.$invalid = !1), c[e] = !1, i(!0, e), s.$setValidity(e, !0, a)));
				else {
					if(u || i(t), r) {
						if(D(r, n)) return
		...
		var Mn = he.cache = {},
			...
			In = /<|&#?\w+;/,
			Bn = /<([\w:]+)/,
			zn = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
			Un = {
				option: [1, '<select multiple="multiple">', "</select>"],
				thead: [1, "<table>", "</table>"],
		...
		vr.prototype = {
			...
			readIdent: function() {
				...
				if(dr.hasOwnProperty(o)) s.fn = dr[o], s.literal = !0, s.constant = !0;
				else {
		...
		var wr = ".",
			...
			Sr = /((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/,
			kr = /^\-?\d+$/;
		Jt.$inject = ["$locale"];
		var Tr = g(dn),
			Er = g(vn);
		...
		var Dr = function(e) {
			...
			Rr = ["badInput"],
			qr = ["$browser", "$sniffer", function(e, t) {
				return {
					restrict: "E",
					require: "?ngModel",
			...
			Ur = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", function(e, t, n, i, a, s) {
				...
				var f = i.inheritedData("$formController") || jr,
					p = 0,
					d = this.$error = {};
		...
		var ai = ["$animate", function(e) {
			...
			fi = ["$locale", "$interpolate", function(e, t) {
				var n = /{}/g;
				return {
					restrict: "EA",
					link: function(r, i, a) {
				...
				return {
					...
					link: function(r, l, f, p, d) {
						...
						r.$watchCollection(b, function(e) {
							var f, p, h, v, $, b, S, k, E, A, N, j, D = l[0],
								O = {},
								M = [];
							if(i(e)) A = e, E = g || m;
							else {
							...
							for(v = A.length, p = M.length = A.length, f = 0; f < p; f++)
								if(b = e === A ? f : A[f], S = e[b], k = E(b, S, f), re(k, "`track by` id"), T.hasOwnProperty(k)) N = T[k], delete T[k], O[k] = N, M[f] = N;
								else {
			...
			Ci = ["$compile", "$parse", function(e, r) {
				...
				return {
					...
					link: function(s, u, c, l) {
						...
						function d(t, o, s) {
							function u() {
								var e, n, r, i, u, c, g, b, k, T, E, A, N, j, D, O = {
										"": []
									},
									M = [""],
									L = s.$modelValue,
								...
								for(E = 0; k = H.length, E < k; E++) {
									...
									if(F[f] = P[g], e = d(t, F) || "", (n = O[e]) || (n = O[e] = [], M.push(e)), $) A = y(R.remove(m ? m(t, F) : h(t, F)));
									else {
										if(m) {
											var _ = {};
											_[f] = L, A = m(t, _) === m(t, F)
							...
							x && (e(x)(t), x.removeClass("ng-scope"), x.remove()), o.empty(), o.on("change", function() {
								t.$apply(function() {
									var e, r, i, a, u, c, l, d, g, y = v(t) || [],
										b = {};
									if($) {
										for(i = [], c = 0, d = S.length; c < d; c++)
											for(e = S[c], u = 1, l = e.length; u < l; u++)
												if((a = e[u].element)[0].selected) {
													if(r = a.val(), p && (b[p] = r), m)
														for(g = 0; g < y.length && (b[f] = y[g], m(t, b) != r); g++);
													else b[f] = y[r];
													i.push(h(t, b))
												}
									} else {
						...
						if(l[1]) {
							for(var h, v = l[0], g = l[1], $ = c.multiple, b = c.ngOptions, x = !1, w = $n(t.createElement("option")), C = $n(t.createElement("optgroup")), S = w.clone(), k = 0, T = u.children(), E = T.length; k < E; k++)
								if("" === T[k].value) {
									h = x = T.eq(k);
									break
								}
				...
				function p() {
					...
					e && r && e.$$route === r.$$route && t.equals(e.pathParams, r.pathParams) && !e.reloadOnSearch && !v ? (r.params = e.params, t.copy(r.params, o), n.$broadcast("$routeUpdate", r)) : (e || r) && (v = !1, n.$broadcast("$routeChangeStart", e, r), g.current = e, e && e.redirectTo && (t.isString(e.redirectTo) ? i.path(h(e.redirectTo, e.params)).search(e.params).replace() : i.url(e.redirectTo(e.pathParams, i.path(), i.search())).replace()), a.when(e).then(function() {
						if(e) {
							...
							}), t.isDefined(n = e.template) ? t.isFunction(n) && (n = n(e.params)) : t.isDefined(r = e.templateUrl) && (t.isFunction(r) && (r = r(e.params)), r = l.getTrustedResourceUrl(r), t.isDefined(r) && (e.loadedTemplateUrl = r, n = u.get(r, {
								cache: c
							}).then(function(e) {
								return e.data
			...
			r.decorator("$animate", ["$delegate", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", function(e, n, r, p, m, y, $) {
				...
				function w(e, n, r) {
					function i(e, t) {
						...
						if(n || r) return "leave" == t && (r = n, n = null), b.push({
							event: t,
							fn: n
						}), m.push({
							event: t,
				...
				function C(e, n, r, i, o, a, s) {
					...
					if(S > 0) {
						var j = [];
						if(y.isClassBased) {
							if("setClass" == A.event) j.push(A), k(r, n);
							else if(C[n]) {
								var D = C[n];
								D.event == e ? N = !0 : (j.push(D), k(r, n))
							}
						} else if("leave" == e && C["ng-leave"]) N = !0;
						else {
				...
				function k(e, t) {
					if(u(e, p)) g.disabled || (g.running = !1, g.structural = !1);
					else if(t) {
						var n = e.data(d) || {},
							r = t === !0;
				...
				function C(e, t, n, r) {
					...
					var p = u.stagger,
						...
						g = Math.max(d.transitionDelay, d.animationDelay),
						m = g * W,
						y = Date.now(),
						$ = M + " " + D,
						b = "",
					...
					var T = h * (Math.max(p.animationDelay, p.transitionDelay) || 0),
						E = (g + v) * U,
						N = (T + E) * W;
				...
				return {
					...
					beforeSetClass: function(e, t, n, r) {
						var i = N(n, "-remove") + " " + N(t, "-add"),
							o = k("setClass", e, i, function(r) {
								var i = e.attr("class");
		...
		i.factory("$swipe", [function() {
			...
			function o(e, t, n) {
				for(var r = 0; r < e.length; r += 2)
					if(i(e[r], e[r + 1], t, n)) return e.splice(r, r + 2), !0;
				return !1
			}
			...
			function s(e) {
				...
				l.push(r, i), n(function() {
					for(var e = 0; e < l.length; e += 2)
						if(l[e] == r && l[e + 1] == i) return void l.splice(e, e + 2)
				}, h, !1)
			}
	...
	function(e, t) {
		...
		var n = "@2x",
			...
			i = /captcha/,
			o = e.module("ngRetina", []).config(["$provide", function(e) {
				e.decorator("ngSrcDirective", ["$delegate", function(e) {
					return e[0].compile = function(e, t) {}, e
				}])
			}]);
	...
	}(window.angular), "undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "angular-md5"),
	function(e) {
	...
	function(e) {
		e.Jcrop = function(t, n) {
			...
			var L, P = e.extend({}, e.Jcrop.defaults),
			...
			var q = {
				...
				I = !0;
			if("IMG" == t.tagName) {
				if(0 != _[0].width && 0 != _[0].height) _.width(_[0].width), _.height(_[0].height);
				else {
					var B = new Image;
			...
			var U = z.width(),
				W = z.height(),
				V = e("<div />").width(U).height(W).addClass(i("holder")).css({
					position: "relative",
					backgroundColor: P.bgColor
				}).insertAfter(_).append(z);
			P.addClass && V.addClass(P.addClass);
			var Q = e("<div />"),
				X = e("<div />").width("100%").height("100%").css({
					zIndex: 310,
					position: "absolute",
					overflow: "hidden"
				}),
			...
			I && (Q = e("<img />").attr("src", z.attr("src")).css(q).width(U).height(W), X.append(Q)), R && Y.css({
				overflowY: "hidden"
			});
			var G, K, Z, ee, te, ne, re, ie, oe, ae = P.boundary,
				se = $().width(U + 2 * ae).height(W + 2 * ae).css({
					position: "absolute",
					top: r(-ae),
					left: r(-ae),
					zIndex: 290
			...
			var le = function() {
				...
				he = function() {
					function t(t) {
						se.css({
							zIndex: 450
						}), t ? e(document).bind("touchmove.jcrop", a).bind("touchend.jcrop", u) : p && e(document).bind("mousemove.jcrop", r).bind("mouseup.jcrop", i)
					}
					...
					function i(e) {
						return e.preventDefault(), e.stopPropagation(), re && (re = !1, f(s(e)), de.isAwake() && P.onSelect.call(ge, v(fe.getFixed())), n(), l = function() {}, f = function() {}), !1
					}
					...
					var l = function() {},
						f = function() {},
						p = P.trackDocument;
					return p || se.mousemove(r).mouseup(i).mouseout(i), z.before(se), {
						activateHandlers: o,
						setCursor: c
					}
				}(),
				ve = function() {
					...
					return P.keySupport && (o.keydown(i).blur(n), R || !P.fixedSupport ? (o.css({
						position: "absolute",
						left: "-20px"
					}), a.append(o).insertBefore(z)) : o.insertBefore(z)), {
						watchKeys: t
					}
				}();
		...
		createUploadForm: function(e, t, n) {
			...
			if(n)
				for(var a in n) jQuery('<input type="hidden" name="' + a + '" value="' + n[a] + '" />').appendTo(o);
			var s = jQuery("#" + t),
				u = jQuery(s).clone(!0);
		...
		ajaxFileUpload: function(e) {
			...
			var t = (new Date).getTime(),
				...
				r = (jQuery.createUploadIframe(t, e.secureuri), "jUploadFrame" + t),
				i = "jUploadForm" + t;
